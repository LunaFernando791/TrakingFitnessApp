...
package com.example.trackingfitness.tracking.preference;
...
import com.example.trackingfitness.tracking.utils.CameraSource;

import java.util.HashMap;
import java.util.List;
import java.util.Map;

/** Configures live preview demo settings for Pose Detection. */
public class LivePreviewPreferenceFragment extends PreferenceFragment {
  ...
  private void setUpCameraPreviewSizePreference(
          int previewSizePrefKeyId, int pictureSizePrefKeyId, int cameraId) {
    ...
    try {
      ...
      if (previewSizePreference.getEntry() == null) {
        // First time opening the Settings page.

...
//import com.example.trackingfitness.tracking.utils.GraphicOverlay.Graphic
//
...
//  private val selectedExercise: String, // Nuevo parámetro
//  private val repetitionCount: Int // Nuevo parámetro
//) : Graphic(overlay) {
...
//    }
//
//    // Dibujar el ejercicio seleccionado y las repeticiones
//    canvas.drawText("Ejercicio: $selectedExercise", 50f, 100f, textPaint)
//    canvas.drawText("Repeticiones: $repetitionCount", 50f, 180f, textPaint)
//

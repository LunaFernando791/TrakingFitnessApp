...
//                MiniGameCard(1,"image", "Push-Ups","Make many push-ups how you can.", exerciseId = 1, navController)
//                MiniGameCard(2, "image", "Wall Sit ","Make the most time on wall site.", exerciseId = 2, navController)
//                MiniGameCard(3, "image", "Plank","Make the most time in plank position.", exerciseId = 3, navController)
//            }
//        }
//    }
//}
...
////            },
//            .clickable {
//                navController.navigate("cameraScreenV2/$exerciseId?isChallenge=true")
//            },
...
fun MiniGamesScreen(
    ...
    val ranking by miniGamesViewModel.globalRanking.collectAsState()
        ...
        Column(
            ...
            Column {
                ...
                if (ranking.isNotEmpty()) {
                    for ((index, user) in ranking.take(5).withIndex()) {
                        PositionCard(
                            position = index + 1,
                            name = user.alias,
